/*
  # Add Chatbot Knowledge Base Entries

  1. New Content
    - Adds comprehensive knowledge base entries for the chatbot
    - Includes information about services, pricing, process, designers, locations, materials, timeline, payment, registration, and styles
  2. Security
    - No security changes
*/
...
We are continuously expanding our network. If your city is not listed, please register your project anyway, and we will try to connect you with designers who can work remotely or travel to your location.',
