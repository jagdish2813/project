/*
  # Add chatbot knowledge entries
  
  1. New Data
    - Add multiple knowledge entries for the chatbot system
    - Categories include: services, pricing, process, designers, locations, materials, timeline, payment, registration, styles
  
  2. Content
    - Each entry includes question, answer, keywords, and priority
*/
